...
if("TRUE" STREQUAL "TRUE")
  set(tags_detection_SOURCE_PREFIX /home/leroypc/RM/shit_ws/src/tags_detection)
  set(tags_detection_DEVEL_PREFIX /home/leroypc/RM/shit_ws/devel)
  ...
  set(tags_detection_INSTALL_PREFIX /home/leroypc/RM/shit_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tags_detection' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/leroypc/RM/shit_ws/src/tags_detection/${idir}'.  Ask the maintainer 'leory <leory@todo.todo>' to fix it.")
    endif()
...
set(tags_detection_EXPORTED_TARGETS "tags_detection_generate_messages_cpp;tags_detection_generate_messages_lisp;tags_detection_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${tags_detection_dep}_FOUND)
      find_package(${tags_detection_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${tags_detection_dep} REQUIRED ${depend_list})
  endif()
