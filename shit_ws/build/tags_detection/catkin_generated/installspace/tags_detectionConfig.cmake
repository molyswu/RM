...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tags_detection' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/leroypc/RM/shit_ws/install/${idir}'.  Ask the maintainer 'leory <leory@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/leroypc/RM/shit_ws/install/lib;/home/leroypc/click/devel/lib;/opt/lula/lib;/opt/ros/indigo/lib)
