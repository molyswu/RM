...
_generate_module_cpp(detect_car
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/detect_car
  "${ALL_GEN_OUTPUT_FILES_cpp}"
)

add_custom_target(detect_car_generate_messages_cpp
...
add_custom_target(detect_car_gencpp)
add_dependencies(detect_car_gencpp detect_car_generate_messages_cpp)
...
### Generating Module File
_generate_module_lisp(detect_car
  ${CATKIN_DEVEL_PREFIX}/${genlisp_INSTALL_DIR}/detect_car
  "${ALL_GEN_OUTPUT_FILES_lisp}"
)

add_custom_target(detect_car_generate_messages_lisp
...
# target for backward compatibility
add_custom_target(detect_car_genlisp)
add_dependencies(detect_car_genlisp detect_car_generate_messages_lisp)
...
### Generating Module File
_generate_module_py(detect_car
  ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/detect_car
  "${ALL_GEN_OUTPUT_FILES_py}"
)

add_custom_target(detect_car_generate_messages_py
...
# target for backward compatibility
add_custom_target(detect_car_genpy)
add_dependencies(detect_car_genpy detect_car_generate_messages_py)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS detect_car_generate_messages_py)



if(gencpp_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/detect_car)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/detect_car
    DESTINATION ${gencpp_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_cpp)
  add_dependencies(detect_car_generate_messages_cpp std_msgs_generate_messages_cpp)
endif()
...
if(genlisp_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genlisp_INSTALL_DIR}/detect_car)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${genlisp_INSTALL_DIR}/detect_car
    DESTINATION ${genlisp_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_lisp)
  add_dependencies(detect_car_generate_messages_lisp std_msgs_generate_messages_lisp)
endif()
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/detect_car)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/detect_car\")")
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/detect_car
    DESTINATION ${genpy_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_py)
  add_dependencies(detect_car_generate_messages_py std_msgs_generate_messages_py)
endif()
if(TARGET geometry_msgs_generate_messages_py)
  add_dependencies(detect_car_generate_messages_py geometry_msgs_generate_messages_py)
endif()
