...
echo_and_run cd "/home/leroypc/baxter_ws/src/test/vision_opencv/image_geometry"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/leroypc/baxter_ws/build/test/vision_opencv/image_geometry" \
    install \
    $DESTDIR_ARG \
