...
if("TRUE" STREQUAL "TRUE")
  set(baxter_kinect_calibration_SOURCE_PREFIX /home/leroypc/baxter_ws/src/baxter_h2r_packages/baxter_kinect_calibration)
  set(baxter_kinect_calibration_DEVEL_PREFIX /home/leroypc/baxter_ws/devel)
  ...
  set(baxter_kinect_calibration_INSTALL_PREFIX /home/leroypc/baxter_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'baxter_kinect_calibration' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Stephen Brawner <brawner@cs.brown.edu>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'baxter_kinect_calibration' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/leroypc/baxter_ws/src/baxter_h2r_packages/baxter_kinect_calibration/${idir}'.  Ask the maintainer 'Stephen Brawner <brawner@cs.brown.edu>' to fix it.")
    endif()
...
set(depends "cv_bridge;image_geometry;image_transport;camera_info_manager;pcl_ros;roscpp;tf;visualization_msgs;std_msgs;tf2;message_runtime;sensor_msgs;geometry_msgs;resource_retriever;pcl_conversions;dynamic_reconfigure")
